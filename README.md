...
<ul>
  <li><a href="#-быстрый-старт-docker">▶️ Быстрый старт (Docker)</a></li>
  <li><a href="#-локальная-разработка--тесты">🧪 Тесты (pytest)</a></li>
  <li><a href="#-структура-проекта">🗂️ Структура проекта</a></li>
  <li><a href="#-миграции-alembic">🗄️ Миграции (Alembic)</a></li>
  <li><a href="#-полезные-команды">🧰 Полезные команды</a></li>
  <li><a href="#-поддерживаемые-платформы">💻 Поддерживаемые платформы</a></li>
